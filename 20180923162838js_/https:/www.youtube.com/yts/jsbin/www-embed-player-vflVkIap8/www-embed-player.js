...
hf("//web.archive.org/web/20180923162840/https://static.doubleclick.net/instream/ad_status.js",a);uf.push(qf(function(){vf||"google_ad_status"in window||(of("//web.archive.org/web/20180923162840/https://static.doubleclick.net/instream/ad_status.js",a),O("DCLKSTAT",3))},5E3))}}
...
b=Ce("//web.archive.org/web/20180923162840/https://googleads.g.doubleclick.net/pagead/id",a)}),function(a){a instanceof Ed&&b.abort();
return Bd(a)})}
...
G.brdim=g.join();Ia=(G.vis={visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[Ga.visibilityState||Ga.webkitVisibilityState||Ga.mozVisibilityState||""]||0,G.wgl=!!B.WebGLRenderingContext,G);for(var ge in Ia)b[ge]=Ia[ge];b.bid=a;b.bsq=Ei++;Ie("//web.archive.org/web/20180923162840/https://www.youtube.com/ad_data_204",{xa:!1,C:b,withCredentials:!0})},function(){}),T(Di,18E5)}catch(b){R(b)}}}
...
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();P("PL_ATT")&&Af.dispose();a=0;for(var b=uf.length;a<b;a++)tf(uf[a]);uf.length=0;nf("//web.archive.org/web/20180923162840/https://static.doubleclick.net/instream/ad_status.js");vf=!1;O("DCLKSTAT",0);cd(Li,Ki);if(a=Ji)a.removeEventListener("onScreenChanged",Oi),a.removeEventListener("onLogClientVeCreated",Ni),a.removeEventListener("onLogServerVeCreated",Pi),a.removeEventListener("onLogVeClicked",Qi),a.removeEventListener("onLogVesShown",Ri),a.removeEventListener("onReady",Si),a.destroy();Mi=
{}});
...
/*
     FILE ARCHIVED ON 16:28:40 Sep 23, 2018 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 10:36:14 Jun 19, 2019.
...
/*
playback timings (ms):
  LoadShardBlock: 111.106 (3)
  esindex: 23.153
  captures_list: 258.208
  CDXLines.iter: 26.707 (3)
  PetaboxLoader3.datanode: 159.017 (5)
  exclusion.robots: 0.151
  exclusion.robots.policy: 0.141
  RedisCDXSource: 6.04
  PetaboxLoader3.resolve: 227.126 (2)
  load_resource: 353.864
*/